...
<br />
![Linux Icon for Linux Module](https://github.com/sadishihab/linux/blob/main/linux.png "OS & Linux Basics Module")
...
- `pwd` = Show current directory. Example Output: `/home/sadi`
...
- `cd /home/sadi` = Go to my home directory (absolute path)
...
- `su - admin` = Switch from sadi user to admin
</details>
...
- `HOME=/home/sadi`= current user's home directory
- `USER=sadi` = currently logged in user
<!-- -->
...
- `PATH=$PATH:/home/sadi` = Appending /home/sadi folder to the existing $PATH value
